...
class Ui_CCStorage(object):
    def setupUi(self, CCStorage):
        ...
        CCStorage.resize(1320, 775)
        CCStorage.setMinimumSize(QtCore.QSize(1320, 775))
        CCStorage.setMaximumSize(QtCore.QSize(1320, 775))
...
"color: rgb(15, 251, 255);")
        ...
        self.cc_api_textEdit = QtWidgets.QTextEdit(self.centralwidget)
        self.cc_api_textEdit.setGeometry(QtCore.QRect(410, 380, 171, 31))
        self.cc_api_textEdit.setAutoFillBackground(True)
        self.cc_api_textEdit.setStyleSheet("color: rgb(14, 255, 255);")
        self.cc_api_textEdit.setObjectName("cc_api_textEdit")
        self.an_rn_api_textEdit = QtWidgets.QTextEdit(self.centralwidget)
        self.an_rn_api_textEdit.setGeometry(QtCore.QRect(410, 420, 171, 31))
        self.an_rn_api_textEdit.setStyleSheet("color: rgb(25, 255, 247);")
        self.an_rn_api_textEdit.setObjectName("an_rn_api_textEdit")
        self.comboBox = QtWidgets.QComboBox(self.centralwidget)
        self.comboBox.setGeometry(QtCore.QRect(410, 520, 521, 31))
        self.comboBox.setStyleSheet("color: rgb(255, 0, 0);")
        self.comboBox.setEditable(True)
        self.comboBox.setObjectName("comboBox")
        self.comboBox.addItem("")
        self.comboBox.addItem("")
        self.bin_lookup_button = QtWidgets.QPushButton(self.centralwidget)
        self.bin_lookup_button.setGeometry(QtCore.QRect(940, 520, 101, 31))
        self.bin_lookup_button.setStyleSheet("font: 14pt \"HACKED\";\n"
"color: rgb(15, 251, 255);")
        self.bin_lookup_button.setObjectName("bin_lookup_button")
        CCStorage.setCentralWidget(self.centralwidget)
        self.statusBar = QtWidgets.QStatusBar(CCStorage)
        self.statusBar.setObjectName("statusBar")
        CCStorage.setStatusBar(self.statusBar)
    ...
    def retranslateUi(self, CCStorage):
        ...
        CCStorage.setWindowTitle(_translate("CCStorage", "CC Sorter"))
        ...
        self.treeWidget.headerItem().setText(1, _translate("CCStorage", "Credit Card Number"))
        self.treeWidget.headerItem().setText(2, _translate("CCStorage", "M/YYYY"))
        self.treeWidget.headerItem().setText(3, _translate("CCStorage", "Sec. Code"))
        self.treeWidget.headerItem().setText(4, _translate("CCStorage", "Full Name"))
        ...
        self.treeWidget.headerItem().setText(8, _translate("CCStorage", "ZIP Code"))
        self.treeWidget.headerItem().setText(9, _translate("CCStorage", "COUNTRY"))
        self.treeWidget.headerItem().setText(10, _translate("CCStorage", "I.P Address"))
        self.treeWidget.headerItem().setText(11, _translate("CCStorage", "User Agent"))
        self.treeWidget.headerItem().setText(12, _translate("CCStorage", "Sourced Location"))
        __sortingEnabled = self.treeWidget.isSortingEnabled()
        self.treeWidget.setSortingEnabled(False)
        self.treeWidget.topLevelItem(0).setText(0, _translate("CCStorage", "2024-09-08 15:00:35"))
        self.treeWidget.topLevelItem(0).setText(1, _translate("CCStorage", "123456678980"))
        self.treeWidget.topLevelItem(0).setText(2, _translate("CCStorage", "12/34"))
        self.treeWidget.topLevelItem(0).setText(3, _translate("CCStorage", "241"))
        self.treeWidget.topLevelItem(0).setText(4, _translate("CCStorage", "John Doe"))
        self.treeWidget.topLevelItem(0).setText(5, _translate("CCStorage", "123 UpUrAss Lane"))
        self.treeWidget.topLevelItem(0).setText(6, _translate("CCStorage", "FuckYourMom"))
        self.treeWidget.topLevelItem(0).setText(7, _translate("CCStorage", "WA"))
        self.treeWidget.topLevelItem(0).setText(8, _translate("CCStorage", "666266"))
        self.treeWidget.topLevelItem(0).setText(9, _translate("CCStorage", "FUKOF"))
        ...
        self.cc_api_textEdit.setToolTip(_translate("CCStorage", "Easy to obtain by going to\n"
"https://zylalabs.com and using a live CC\n"
"Payment gateway is stripe."))
        self.cc_api_textEdit.setPlaceholderText(_translate("CCStorage", "CC BIN API"))
        self.an_rn_api_textEdit.setToolTip(_translate("CCStorage", "Easy to obtain by going to\n"
"https://zylalabs.com and using a live CC\n"
"Payment gateway is stripe."))
        self.an_rn_api_textEdit.setPlaceholderText(_translate("CCStorage", "AN/RN Check API"))
        self.comboBox.setCurrentText(_translate("CCStorage", "440365"))
        self.comboBox.setItemText(0, _translate("CCStorage", "440365"))
        self.comboBox.setItemText(1, _translate("CCStorage", "440432"))
        self.bin_lookup_button.setText(_translate("CCStorage", "BIN LOOKUP"))
